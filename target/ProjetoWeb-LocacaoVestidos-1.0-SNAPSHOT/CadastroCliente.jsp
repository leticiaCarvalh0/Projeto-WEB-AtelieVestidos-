    ...
    <body>
        ...
        <table>
            <form id="cadastroForm" name="cadastroForm" action="${pageContext.request.contextPath}${URL_BASE}/ClienteControlador" method="get">
                ...
                <p><label>Nome:</label> <input type="text" name="nomeCidade" value="${nomeCliente}" size="40" /> </p>
                <p><label>E-mail:</label> <input type="text" name="email" value="${email}" size="5" /> </p>
                ...
                <tr>
                    ...
                    <td>
                        <form name="cadastroForm" action="${pageContext.request.contextPath}${URL_BASE}/ClienteControlador" method="get">
                            ...
                            <input type="hidden" name="nomeCidade" value="${cliente.nomeCliente}" >
